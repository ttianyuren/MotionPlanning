...
(define (domain pick-and-place_propo_reorder)
   ...
   (:action a0_locate_body
          ...
          :effect (and (located o10 p248) (not (allowlocate)) (increase (total-cost) 50) (not (_applicable _p0)) (when (and (not (_unused _s0)) (not (_unused _s3)) (not (_unused _s8)) (not (_unused _s12)) (not (_unused _s13)) (not (_unused _s29)) (not (_unused _s38)) (not (_unused _s80))) (_applicable _p1)) (when (and (not (_unused _s0)) (not (_unused _s3)) (not (_unused _s8)) (not (_unused _s12)) (not (_unused _s13)) (not (_unused _s29)) (not (_unused _s38)) (not (_unused _s80))) (_applicable _p1)))
   )
   (:action a1_move_free
          :parameters (q416 #q0 #t18)
          :precondition (and (isfreemotion q416 #t18 #q0) (atconf q416) (handempty) (canmove) (_applicable _p1))
          :effect (and (atconf #q0) (not (atconf q416)) (not (canmove)) (canpick) (increase (total-cost) 100) (not (_applicable _p1)) (not (_unused _s12)) (not (_unused _s29)) (when (and (not (_unused _s0)) (not (_unused _s3)) (not (_unused _s8)) (not (_unused _s13)) (not (_unused _s38)) (not (_unused _s80))) (_applicable _p2)) (not (_unused _s12)) (not (_unused _s29)) (when (and (not (_unused _s0)) (not (_unused _s3)) (not (_unused _s8)) (not (_unused _s13)) (not (_unused _s38)) (not (_unused _s80))) (_applicable _p2)))
   )
   (:action a2_pick
          ...
          :effect (and (atgrasp o10 #g0) (canmove) (not (atpose o10 p248)) (not (handempty)) (increase (total-cost) 100) (not (_applicable _p2)) (not (_unused _s12)) (not (_unused _s8)) (when (and (not (_unused _s0)) (not (_unused _s3)) (not (_unused _s13)) (not (_unused _s29)) (not (_unused _s38)) (not (_unused _s80))) (_applicable _p3)) (not (_unused _s12)) (not (_unused _s8)) (when (and (not (_unused _s0)) (not (_unused _s3)) (not (_unused _s13)) (not (_unused _s29)) (not (_unused _s38)) (not (_unused _s80))) (_applicable _p3)))
   )
   (:action a3_move_holding
          ...
          :effect (and (atconf #q1) (not (atconf #q0)) (not (canmove)) (canpick) (canplace) (increase (total-cost) 100) (not (_applicable _p3)) (not (_unused _s12)) (not (_unused _s8)) (not (_unused _s13)) (not (_unused _s80)) (when (and (not (_unused _s0)) (not (_unused _s3)) (not (_unused _s29)) (not (_unused _s38))) (_applicable _p4)) (not (_unused _s12)) (not (_unused _s8)) (not (_unused _s13)) (not (_unused _s80)) (when (and (not (_unused _s0)) (not (_unused _s3)) (not (_unused _s29)) (not (_unused _s38))) (_applicable _p4)))
   )
   (:action a4_place
   ...
   (:action a5_move_free
          ...
          :effect (and (atconf q416) (not (atconf #q1)) (not (canmove)) (canpick) (increase (total-cost) 100) (not (_applicable _p5)) (not (_unused _s38)) (not (_unused _s13)) (when (and (not (_unused _s0)) (not (_unused _s3)) (not (_unused _s8)) (not (_unused _s12)) (not (_unused _s29)) (not (_unused _s80))) (_applicable _p6)) (not (_unused _s38)) (not (_unused _s13)) (when (and (not (_unused _s0)) (not (_unused _s3)) (not (_unused _s8)) (not (_unused _s12)) (not (_unused _s29)) (not (_unused _s80))) (_applicable _p6)))
   )
   ...
   (:action s3_sample-grasp-dir
          ...
          :effect (and (isgraspdir o10 p248 #d0) (_unused _s3))
   )
   (:action s8_sample-grasp
          :parameters (o10 p248 #d0)
          :precondition (isgraspdir o10 p248 #d0)
          :effect (and (graspatpose #g0 p248) (isgrasp o10 #g0) (not (_unused _s3)) (_unused _s8))
   )
   (:action s12_inverse-kinematics
          :parameters (o10 p248 #g0)
          :precondition (and (ispose o10 p248) (isgrasp o10 #g0))
          :effect (and (isconf #q0) (istraj #t1) (iskin o10 p248 #g0 #q0 #t1) (not (_unused _s8)) (_unused _s12))
   )
   ...
   (:action s29_plan-free-motion
          ...
          :effect (and (isfreemotion q416 #t18 #q0) (not (_unused _s12)) (_unused _s29))
   )
   (:action s38_plan-free-motion
          :parameters (#q1 q416)
          :precondition (and (isconf #q1) (isconf q416))
          :effect (and (isfreemotion #q1 #t27 q416) (not (_unused _s13)) (_unused _s38))
   )
   (:action s80_plan-holding-motion
          :parameters (#q0 #q1 o10 #g0)
          :precondition (and (isconf #q0) (isconf #q1) (isgrasp o10 #g0))
          :effect (and (isholdingmotion #q0 #t69 #q1 o10 #g0) (not (_unused _s12)) (not (_unused _s8)) (not (_unused _s13)) (_unused _s80))
   )
)
